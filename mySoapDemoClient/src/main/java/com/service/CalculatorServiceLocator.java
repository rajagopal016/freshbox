...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.service.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8181/mySoapDemo/services/Calculator";
    ...
    public com.service.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.service.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.CalculatorSoapBindingStub _stub = new com.service.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.CalculatorSoapBindingStub _stub = new com.service.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "Calculator"));
        }
